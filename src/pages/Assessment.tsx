...
const questionDefinitions = [
    ...
    },
  {
    ...
    options: [
      {
        value: "leader",
        label: "Lead: Bring the team together, make a new plan, take charge",
      },
      {
        value: "doer",
        label: "Do: Do the work myself to finish it",
      },
      {
        value: "learning",
        label: "Learn: Find out what went wrong, write it down",
      },
      {
        value: "strategic",
        label: "Support: Check if the team is okay, fix the real problem",
      },
    ],
  },
];
